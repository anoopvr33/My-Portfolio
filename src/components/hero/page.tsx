...
export default function PortfolioWelcome({
  ...
  return (
    <div className="max-w-5xl h-180 md:h-screen p-4 sm:p-20  w-full grid md:grid-cols-2 gap-10 items-center">
      {/* Image */}
      ...
      <div className="space-y-6 order-2 mt-20 md:order-1 text-center md:text-left">
        <p className="text-sm uppercase tracking-[0.3em] text-slate-400">
          Welcome To My Portfolio
        </p>
        <div className="md:flex gap-10 items-center w-full mt-20   md:w-[66vw]  justify-center md:justify-start">
        ...
        <div className="space-y-2 -mt-25 w-full p-10  pt-10 text-start rounded-2xl   md:w-[66vw]">
          <div>
